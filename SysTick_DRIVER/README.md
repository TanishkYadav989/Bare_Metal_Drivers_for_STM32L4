...
We have Initialized the SysTick function with an argument Ticks which is the Frequency to be set for the timer.
...
Further we set the priority of the interrupt using SHPR which is set as lowest priority, and 11 is the Interrupt number of SysTick in Vector Table.

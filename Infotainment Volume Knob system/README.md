...
4. PB9 used for the button input for warning override.
 ...
 10. ADC1 is enabled along with its interrupt & polled until the ADC ready flag is set in the status register. When it's ready the conversion is initiated by setting ADC start bit in CR.

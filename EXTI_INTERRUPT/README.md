...
Finally we allot the priority of the Interrupt as 0x10 (8 bit as only upper four bits determine it) which is high & then enabling it by ISER0 beacuse it is at 23 position in the Vector Table.

...
Finally we allot the priority of the Interrupt as 0x10 (8 bit as only upper four bits determine it) which is high & then enabling it by ISER0 because it is at 23 position in the Vector Table.
...
Lastly in the main fuction, I call the the LED_ACTIVATE() from gpio.h, button_init() & exti_init() and perform the operation of toggling the led when the button is pressed.
